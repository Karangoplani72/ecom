...
class StaffDashboardView extends ConsumerWidget {
    ...
    return CustomScrollView(
      ...
      slivers: [
            ...
            delegate: SliverChildListDelegate([
              ...
              if (perms.has(StaffPermission.customers))
                _ModuleCard(
                  ...
                  color: Colors.orange,
                  onTap: () => context.go('/seller/customers'),
                  isDark: isDark,
                ),
        ...
        if (!perms.has(StaffPermission.inventory) &&
            ...
            !perms.has(StaffPermission.analytics))
          SliverToBoxAdapter(
            child: Padding(
